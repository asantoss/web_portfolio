...
export default function Header(props) {
	...
	return (
		<section
			{...props}
			className='text-center profile right-0 lg:left-0 bg-gray-900 h-screen py-2 fixed w-full lg:w-1/2 flex items-center justify-center text-5xl font-bold flex-col'>
